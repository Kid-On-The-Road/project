...
//
///**
// * Excel生成辅助类(注：非线程安全，多线程下请使用ExcelUtilEx类)
// */
//public class ExcelUtilExa {
//
//    private ExcelUtilExa() {
//        //工具类无需对象实例化
//    }
//
...
//    private static CellStyle dateContentStyle; // 日期内容行样式
...
//                                //日期格式
//                                DateTimeFormat annotation = ReflectionUtil.getAnnotation(obj, fieldNames[num],
//                                        DateTimeFormat.class);
//                                if (annotation != null) {
//                                    dateContentStyle.setDataFormat(format.getFormat(annotation.pattern()));
//                                } else {
//                                    dateContentStyle.setDataFormat(format.getFormat("yyyy/MM/dd"));
//                                }
//                                cells[cellNum].setCellStyle(dateContentStyle);
...
//        dateContentStyle = wb.createCellStyle();
...
//     * 初始化日期内容单元格样式
//     */
//    private static void initDateContentCellStyle() {
//        dateContentStyle.setAlignment(CellStyle.ALIGN_CENTER);
//        dateContentStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
//        dateContentStyle.setFont(contentFont);
//        dateContentStyle.setBorderTop(CellStyle.BORDER_THIN);
//        dateContentStyle.setBorderBottom(CellStyle.BORDER_THIN);
//        dateContentStyle.setBorderLeft(CellStyle.BORDER_THIN);
//        dateContentStyle.setBorderRight(CellStyle.BORDER_THIN);
//        dateContentStyle.setTopBorderColor(IndexedColors.BLACK.index);
//        dateContentStyle.setBottomBorderColor(IndexedColors.BLACK.index);
//        dateContentStyle.setLeftBorderColor(IndexedColors.BLACK.index);
//        dateContentStyle.setRightBorderColor(IndexedColors.BLACK.index);
//        dateContentStyle.setWrapText(true); // 字段换行
//    }
//
//    /**
